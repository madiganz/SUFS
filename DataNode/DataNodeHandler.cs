...
namespace DataNode
{
    ...
    {
        /// <summary>
        /// Server side handler of the ForwardDataBlock RPC. DataNode writes block to a file and then returns success status of write.
        /// </summary>
        ...
        public override Task<DataNodeProto.StatusResponse> WriteDataBlock(DataNodeProto.DataBlock blockContainer, ServerCallContext context)
        {
            ...
            bool writeSuccess = BlockStorage.Instance.WriteBlock(filePath, blockContainer.Data.ToByteArray());
